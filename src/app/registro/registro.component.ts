...
export class RegistroComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,private servicio: RegistrousrService, 
    ...
    this.datos = new FormGroup({
      ...
      'estadosalud': new FormControl('verde', Validators.required) 
     });
  }
  guardarCambios():void{
    this.datos2 = this.datos.value;
    if((this.datos2.nombre!="") &&(this.datos2.apellidop!="") &&(this.datos2.apellidom!="") &&(this.datos2.calle!="") &&(this.datos2.estado!="") &&(this.datos2.municipio!="") && (this.datos2.correo!="") &&(this.datos2.contrasena!="") &&(this.datos2.contra2!="") &&(this.datos2.numerocel!="") && (this.datos2.estadosalud!="")){
